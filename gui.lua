...
Misc:Divider({Name = "Crosshair"})
Misc:Toggle({Name = "Enable Crosshair", Flag = "Misc_Crosshair", Default = true})
Misc:List({Name = "Style", Flag = "Misc_CrosshairStyle", Options = {"Plus", "Cross", "Dot", "Circle"}, Default = "Plus"})
Misc:Slider({Name = "Length", Flag = "Misc_CrosshairLength", Min = 1, Max = 30, Default = 10, Decimals = 1})
Misc:Slider({Name = "Thickness", Flag = "Misc_CrosshairThickness", Min = 1, Max = 8, Default = 2, Decimals = 1})
Misc:Slider({Name = "Gap", Flag = "Misc_CrosshairGap", Min = 0, Max = 15, Default = 3, Decimals = 1})
Misc:Colorpicker({Name = "Color", Flag = "Misc_CrosshairColor", Default = Color3.fromRGB(0, 255, 0)})
Misc:Toggle({Name = "Outline", Flag = "Misc_CrosshairOutline", Default = true})
Misc:Toggle({Name = "Center Dot", Flag = "Misc_CrosshairDot"})
...
-- ===== CROSSHAIR RENDERER =====
do
	-- Renders a customizable crosshair at screen center so it stays visible during FPS Mode.
	...
	Crosshair.Parent = Library.ScreenGUI
	...
	local function Render()
		local Enabled = Library.Flags.Misc_Crosshair and not Library.Flags.Misc_Panic
		Crosshair.Visible = Enabled
		if not Enabled then return end

		local Color = Library.Flags.Misc_CrosshairColor or Color3.fromRGB(0, 255, 0)
		local Thickness = Library.Flags.Misc_CrosshairThickness or 2
		local Length = Library.Flags.Misc_CrosshairLength or 10
		local Gap = Library.Flags.Misc_CrosshairGap or 3
		local Style = Library.Flags.Misc_CrosshairStyle or "Plus"
		local UseOutline = Library.Flags.Misc_CrosshairOutline ~= false
		local UseDot = Library.Flags.Misc_CrosshairDot
