...
Trigger:List({Name = "Method", Flag = "SilentAim_Method", Options = {"Auto", "Ray Redirect", "Mouse Assist"}, Default = "Auto"})
Trigger:Keybind({Name = "Activation Key", Flag = "SilentAim_Key", Mode = "Hold", Default = Enum.UserInputType.MouseButton1})
